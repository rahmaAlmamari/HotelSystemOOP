namespace HotelSystemOOP
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //to load the guest details from the file ...
            Guest.LoadGuestDetailsFromFile();
            //to load the reservation details from the file ...
            Reservation.LoadReservationDetailsFromFile();
            ...
            do
            {
                ...
                switch (choice)
                {
                    ...
                    case '0':
                        ...
                        //to save room details to file before exiting ...
                        Room.SaveRoomDetailsToFile();
                        //to save guest details to file before exiting ...
                        Guest.SaveGuestDetailsToFile();
                        //to save the reservation details to file before exiting ...
                        Reservation.SaveReservationDetailsToFile();
                        break;
                    default:
